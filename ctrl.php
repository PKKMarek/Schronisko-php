...
// Nazwy do zmiany "dog"
getRouter()->addRoute('DogShowAll', 'DogListCtrl',  ['user','admin']);
getRouter()->addRoute('DogShowLike','DogListCtrl',  ['user','admin']);
...
getRouter()->addRoute('DogDelete',  'DogEditCtrl',  ['moderator','admin']);

// Nazwy do zmiany "person"
getRouter()->addRoute('personShowAll',  'PersonListCtrl',	['moderator','admin']);
getRouter()->addRoute('personShowLike',  'PersonListCtrl',	['user','admin']);
